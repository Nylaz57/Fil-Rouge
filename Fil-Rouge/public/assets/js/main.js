...
if (toggleBtnIcon) {
    toggleBtnIcon.addEventListener("click", function (event) {
        ...
        if (inputMdp.type === "password") {
            inputMdp.type = "text";
            toggleBtnIcon.style.backgroundImage = "url('./assets/img/icons/visibility_FILL0_wght400_GRAD0_opsz24.svg')";
        } else if (inputMdp.type === "text") {
            inputMdp.type = "password";
            toggleBtnIcon.style.backgroundImage = "url('./assets/img/icons/visibility_off_FILL0_wght400_GRAD0_opsz24.svg')";
        }
    });
};
//////////////////////////////////////////////////////////
